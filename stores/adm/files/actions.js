...
const actions = {
	...
	async uploadApiAction(formData) {
		...
		const options = {
			...
			// 	'Authorization': "Bearer 241|WDrgpG7YQK9HgqAwVsDC10VuD3vzhfRWl9T387Ll80d30494"
			// }
		};
		...
		// let error = null
		// try {
		// 	data = await $fetch('http://localhost/api/v1/files', options);
		// } catch (errors) {
